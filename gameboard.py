############# CREDIT FOR THE GAMEBOARD #############################################################
# https://github.com/georgepsarakis/python-chess-board ########
#
#
# Includes initial board state in Python3.4.3
#
#
####################################################################################################
...
class Piece(object):
  ...
  Color = None
  Type = None
  AvailableTypes = [ 'Rook', 'Night', 'Pawn', 'King', 'Queen', 'Bishop' ]
  Types_Direction_Map = {
      'Rook'   : [ 'straight' ],
      'Night' : [ 'gamma' ],
      'Pawn'   : [ 'straight' ],
...
class Board(object):
  ...
  def setup(self):
    ...
    self.add_piece('white', 'King', Square.row_index(1), Square.column_index(5))
    self.add_piece('white', 'Rook', Square.row_index(1), Square.column_index(8))
    self.add_piece('white', 'Night', Square.row_index(1), Square.column_index(7))
    self.add_piece('black', 'King', Square.row_index(8), Square.column_index(5))
    self.add_piece('black', 'Night', Square.row_index(8), Square.column_index(3))
